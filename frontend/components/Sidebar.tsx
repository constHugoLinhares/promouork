...
export default function Sidebar({ userEmail, onLogout }: SidebarProps) {
  ...
  return (
    <div className="fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-dark-surface via-purple-900/30 to-dark-surface shadow-2xl flex flex-col z-10 border-r border-dark-border">
      ...
      <div className="border-t border-dark-border p-4">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-dark-text truncate max-w-[140px]">
                {userEmail}
              </p>
            </div>
          </div>
        ...
        <button
          onClick={onLogout}
          className="w-full flex items-center justify-center px-4 py-2 text-sm text-dark-muted hover:bg-dark-border/30 hover:text-dark-text rounded-lg transition-colors"
        >
